...
export class NotificationService {
  ...
  escanearFacial(estudianteId?: number, rut?: string, accion: 'abordar' | 'llegar' = 'abordar', score: number = 0.95): Observable<any> {
    return this.http.post(`${this.apiUrl}/rutas/escanear-facial/`, {
      estudiante_id: estudianteId,
      rut: rut,
      accion: accion,
      score: score
